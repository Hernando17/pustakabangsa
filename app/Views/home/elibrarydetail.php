...
<head>
  ...
  <title>E-Library | E-Book Detail</title>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <li class="get-started "><a href="<?= base_url('/Ebook/elibrary'); ?>">Kembali</a></li>
        </ul>
      </nav><!-- .nav-menu -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col">
          ...
          <br>
          <div class="card">
            <h5 class="card-header">Detail E-Book</h5>
            <div class="card-body">
                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-md-8 ">
                        <div class="card-body">
                          ...
                          <hr>
                          <p class="card-text ">ISBN : <?= $buku['isbn']; ?></hp>
                          ...
                          <a href="<?= base_url(); ?>/assets/img/pdf/<?= $buku['isi']; ?>" class="btn btn-success">Unduh</a>
