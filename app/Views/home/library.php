  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <li class="get-started "><a href="/Home/opsi">Kembali</a></li>
        </ul>
      </nav><!-- .nav-menu -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col">
          ...
          <br>
          <div class="card">
            <h5 class="card-header">Koleksi Book</h5>
            ...
            <div class="card-body">
              <div class="row content">
                <?php foreach ($offline as $key => $value) { ?>

                  <div class="card buku ukuranbuku">
                    ...
                    <div class="card-body">
                      ...
                      <a href="/Book/librarydetail/<?= $value['slug']; ?>" class="btn btn-danger">Detail</a>
                    </div>
                  </div>
